...
if earnings > costs:  # прибыль
    gain = earnings - costs  # находим прибыль
    print("Финансовый результат - прибыль. Ее величина: {}".format(gain))
    ...
    print('Прибыль фирмы в расчете на одного сотрудника = {}'.format(
        round(gain / employees, 2)))
elif earnings < costs:  # убыль
    print("Финансовый результат - убыль. Ее величина: \033[31m-{}".format(
        costs - earnings))
else:  # Ноль
    print("Финансовый результат - ноль. Доход и расход равны")